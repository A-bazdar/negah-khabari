...
function make_show_news(news, body_news_font, news_content) {
    ...
    images = '';
    if(news['image'] != null){
        images += '<img class="news_img new_news_img b-lazy new_news_img float-center" data-src="' + news['image'] + '" data-action="' + news['id'] + '" src="' + static_url_loading + '" onerror="this.onerror=null;this.src=\'' + static_url_error_image_news + '\';">';
    }
