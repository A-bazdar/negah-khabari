...
class ElasticSearchModel(ElasticSearchBaseModel):
    ...
    def search(self):
        try:
            ...
            Debug.get_exception(sub_system='web', severity='critical_error', tags='elastic_search > search',
    ...
    def insert(self):
        try:
            ...
            Debug.get_exception(sub_system='web', severity='critical_error', tags='elastic_search > insert',
                                data='index: ' + self.index + ' doc_type: ' + self.doc_type + ' body: ' + str(self.body))
            return False
    ...
    def delete(self):
        try:
            ...
            Debug.get_exception(sub_system='web', severity='critical_error', tags='elastic_search > delete',
    ...
    def update(self):
        try:
            ...
            Debug.get_exception(sub_system='web', severity='critical_error', tags='elastic_search > update',
    ...
    def count_all(self):
        try:
            ...
            Debug.get_exception(sub_system='web', severity='critical_error', tags='elastic_search > count_all',
    ...
    def count(self):
        try:
            ...
            Debug.get_exception(sub_system='web', severity='critical_error', tags='elastic_search > count',
                                data='index: ' + self.index + ' doc_type: ' + self.doc_type + ' body: ' + str(self.body))
            return 0
    ...
    def get_one(self):
        try:
            ...
            Debug.get_exception(sub_system='web', severity='critical_error', tags='elastic_search > get_one',
                                data='index: ' + self.index + ' doc_type: ' + self.doc_type + ' id: ' + str(self.id))
            return {}